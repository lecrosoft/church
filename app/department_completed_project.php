...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        <h3 class="page-title">
                            ...
                            List of Completed Projects In <span class="text-danger"><?php echo $department ?> </span> department
                        </h3>
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        <div class="table-responsive">
                                            <table id="completedProjectTable" class="table table-bordered">
                                                <thead>
                                                    <tr>
    ...
    <script>
        $(document).ready(function() {
            $('#completedProjectTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
