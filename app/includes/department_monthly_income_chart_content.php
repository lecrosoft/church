                                                   <script type="text/javascript">
                                                       ...
                                                       function drawChart() {
                                                           var data = google.visualization.arrayToDataTable([
                                                               ['Months', 'Income'],
                                                               <?php
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 1 && year(transaction_date) = year(current_date)";
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 2 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 3 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 4 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 5 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 6 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 7 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 8 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 9 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 10 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 11 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
                                                                $november_income = $row['value_sum'];
                                                                $count_income = mysqli_num_rows($query_lecrosoft);
                                                                // if ($count_income = 0) {
                                                                //     $november_income = 0;
                                                                // } else {
                                                                //     $november_income = $row['value_sum'];
                                                                ...
                                                                $lecrosoft = "SELECT SUM(income) as value_sum FROM department_income WHERE department_id = $depart_id && month(transaction_date) = 12 && year(transaction_date) = year(current_date)";
                                                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                                                $row = mysqli_fetch_assoc($query_lecrosoft);
