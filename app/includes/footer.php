<footer class="footer text-center"> 2021 &copy; brought to you by Lecrosoft </footer>
</div>
<!-- /#page-wrapper -->
</div>
<!-- /#wrapper -->
...
<script src="../plugins/bower_components/jquery-wizard-master/dist/jquery-wizard.js"></script>
