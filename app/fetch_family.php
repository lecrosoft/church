...
if (isset($_POST['family_id'])) {
    ...
    $lecrosoft = "SELECT * FROM family WHERE family_id = $family_id";
...
<form method="POST">
    <div class="form-group mb-3">
        <input type="text" class="form-control" id="fname" value='<?php echo $family_name ?>'>

    </div>
    <div class="form-group mb-3">
        <input type="text" class="form-control" id="fleader" value='<?php echo $family_leader ?>'>

    </div>

    <div class="form-group mb-3">
        <input type="text" class="form-control" id="fquantity" value='<?php echo $family_quantity ?>'>

    </div>
    <div class="form-group mb-3">
        <input type="text" class="form-control" id="fcontact" value='<?php echo $family_contact ?>'>
