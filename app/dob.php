                                ...
                                <div class="white-box">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <?php $lecrosoft = "SELECT * FROM student WHERE month(current_date) = month(dob) AND day(current_date) = day(dob)";
                                            $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                            $count = mysqli_num_rows($query_lecrosoft); ?>
                                            <h1>we have <?php echo $count  ?>Celebrants today</h1>
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query_lecrosoft)) {
                                                    ...
                                                    echo "<td>$name</td>";
                                                    echo "<td> $dob</td>";
                                                    echo "<td> Happy birthday <b>$name</b></td>";
                                                    echo "</tr>";
                                                };
                                                ?>
