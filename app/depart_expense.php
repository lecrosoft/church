                                    ...
                                    <div class="clearfix">
                                        <div class="row">
                                            <h4 class="card-title float-left col-md-9">
                                                <span class="text-danger"><?php echo $department ?></span> Department Expenses Reports
                                            </h4>
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                ...
                                                <div class="table-responsive monthly_table-data-filter-fetch">
                                                    <?php include('includes/department_monthly_expense_content.php') ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-gradient-danger">
                    <h5 class="modal-title text-white">New <?php echo $department ?> Department Expenses Transaction</h5>
                    ...
                    <form method="POST">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select form-control" name="tcategory" required>
                                ...
                                <?php
                                $lecrosoft = "SELECT * FROM department_expense_category";
                                $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                while ($row = mysqli_fetch_assoc($query_lecrosoft)) {
                                    extract($row);
                                    echo " <option value='$department_expense_cat_id'>$title</option>";
                                }
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="expense_amount" placeholder="Enter Amount" required>
...
if (isset($_POST['add'])) {
    ...
    $lecrosoft = "INSERT INTO `department_expense`(`department_id`, `department_expense_cat_id`, `note`, `transaction_date`, `payment_method_id`, `expense`, `entered_by`) VALUES ($department_id,$tcategory,'$note','$tdate',$payment_method,'$expense_amount','$created_by')";
    $query_lecrosoft = mysqli_query($con, $lecrosoft);
    if ($query_lecrosoft) {
