                               ...
                               function drawChart() {
                                   var data = google.visualization.arrayToDataTable([
                                       ...
                                       <?php
                                        ...
                                        if ($january_expenses == 0) {
                                            echo "['Jan', 0],";
                                        } else {

                                            echo "['Jan', $january_expenses],";
                                        }
                                        ...
                                        if ($august_expenses == 0) {
                                            echo "['Aug', 0],";
                                        } else {

                                            echo "['Aug', $august_expenses],";
                                        }
                                        ...
                                        if ($september_expenses == 0) {
                                            echo "['Sept', 0],";
                                        } else {

                                            echo "['Sept', $september_expenses],";
                                        }
                                        ...
                                        if ($octomber_expenses == 0) {
                                            echo "['Oct', 0],";
                                        } else {

                                            echo "['Oct', $octomber_expenses],";
                                        }
                                        ...
                                        if ($november_expenses == 0) {
                                            echo "['Nov', 0],";
                                        } else {

                                            echo "['Nov', $november_expenses],";
                                        }
                                        ...
                                        if ($december_expenses == 0) {
                                            echo "['Dec', 0]";
                                        } else {

                                            echo "['Dec', $december_expenses]";
                                        }
                                        ?>
                                   ...
                                   var options = {
                                       ...
                                       chart: {
                                           ...
                                           subtitle: 'Expenses analysis for Year : <?php echo date('Y') ?>',
                                       }
                                   };
