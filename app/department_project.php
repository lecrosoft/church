...
<body>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="page-header">
                        <h3 class="page-title">
                            ...
                            List of Projects In <span class="text-danger"><?php echo $department ?> </span> department
                        </h3>
                                ...
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        <div class="table-responsive">
                                            <table id="departmentProjectTable" class="table table-bordered">
                                                <thead>
                                                    <tr>
                            ...
                            <div class="modal-body" id="">
                                ...
                                department_id
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="project_status" id="" class="form-control form-select">
                ...
                if (isset($_POST['add_project'])) {
                    ...
                    $lecrosoft = "INSERT INTO `department_project`(`department_id`, `project_title`, `project_description`, `project_extimation`, `priority`, `status`) VALUES ($departs_id,'$project_title','$project_description','$extimated_cost','$priority','$project_status')";
    ...
    <script>
        $(document).ready(function() {
            $('#departmentProjectTable').DataTable({
                dom: 'Bfrtip',
                buttons: [
