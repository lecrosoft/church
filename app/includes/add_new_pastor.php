...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading">Add New Pastor</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 m-b-10 select2-multiple" name="department" multiple="multiple" data-placeholder="Choose department">
...
if (isset($_POST['submit'])) {
    ...
    $folder = "../assets/uploads/pastors/" . $photo;

    $salary = $_POST['salary'];
    $cv = $_FILES['cv']['name'];
    $cv_temp_files = $_FILES['cv']['tmp_name'];
    $cv_folder = "../assets/uploads/cv/" . $cv;
    ...
    $sql = "INSERT INTO `members`(`title`, `first_name`,`last_name`, `phone_number_one`, `phone_number_two`,`email`, `photo`, `state`, `baptize_date`, `state_of_origin`, `marrital_status`,`employment_status`, `position_id`, `family`,`department`, `country`, `address`,`facebook`,`linktdin`, `city`, `gender`,`date_of_birth`,`salary`, `user_type`,`cv`,`user_role`) 
    VALUES ('$title','$fname','$lname','$phoneone','$phonetwo','$email','$photo','$state','$bptdate','$stateoforigin','$marstatus','$empstatus',$position,'$family','$department','$country','$address','$fb_id','$linkdn','$city','$gender','$dob',$salary,'$member_type','$cv','$user_role')";
