...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.attendance_update').click(function(e) {
                e.preventDefault();
                let attendance_type_id = $(this).attr("id");
                let attendance_type_update = $('#attendance_type_id').val();
                alert(attendance_type_id)

                $.ajax({
                    url: "update_attendance_type.php",
                    method: "POST",
                    data: {
                        attendance_type_id_update: attendance_type_id,
                        attendance_type_update = attendance_type_update
