        ...
        $(function() {
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                                ...
                                borderWidth: 1,
                                fill: "origin",
                                data: [20, 40, 15, 35, 25, 50, 30, 20, 50, 60, 60],
                            },
                            {
                                label: "International",
                                borderColor: "#e9eaee",
            ...
            if ($("#monthly-income-chart").length) {
                ...
                var myChart = new Chart(ctx, {
                    type: "bar",
                    data: {
                        labels: ["JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "MAY", "JUN", "JUL", "AUG"],
                        datasets: [{
                                label: "INCOME",
                                borderColor: gradientStrokeViolet,
                                backgroundColor: gradientStrokeViolet,
                ...
                $("#monthly-income-chart-legend").html(myChart.generateLegend());
            }
            ...
            if ($("#traffic-chart").length) {
                ...
                var trafficChartData = {
                    datasets: [{
                        ...
                        $sql = "SELECT * FROM `members` WHERE marrital_status = 'Married'";

                        $query_sql = mysqli_query($con, $sql);

                        $count_married = mysqli_num_rows($query_sql);


                        $sql = "SELECT * FROM `members` WHERE marrital_status = 'Single'";

                        $query_sql = mysqli_query($con, $sql);

                        $count_single = mysqli_num_rows($query_sql);
                        ...
                        $count_divorced = mysqli_num_rows($query_sql);



                        $sum_of_members = $count_married + $count_single + $count_divorced;


                        $married_percentage = round(($count_married * 100) / $sum_of_members);
                        $single_percentage = round(($count_single * 100) / $sum_of_members);
                        $divorced_percentage = round(($count_divorced * 100) / $sum_of_members);



                        ?>

                        <?php echo "data:" . "[$married_percentage, $single_percentage, $divorced_percentage]," ?>
                        // data: [40, 60, 50],
                        backgroundColor: [
                            gradientStrokeBlue,
                            gradientStrokeGreen,
