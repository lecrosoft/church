                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">
                                    <a href="events.php"><span></span>All Events
                                        <i class="
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="clearfix">
                                        ...
                                        $lecrosoft = "SELECT * FROM `event` LEFT JOIN members ON `event`.member_id = members.member_id WHERE `event`.`status` = 'Active' AND `start_date` = $date ORDER BY event_id DESC";
                                        $query_lecrosoft = mysqli_query($con, $lecrosoft);
                                        $count = mysqli_num_rows($query_lecrosoft);
                                        if ($count == 0) {
                                            echo "<h1> There are no events happening today </h1>";
                                        } else {
                                                ...
                                                <div class="page_button d-flex justify-content-between ">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="form-group pr-2">
                                                            <h2>All events happening today</h2>
