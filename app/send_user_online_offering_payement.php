...
if (isset($_POST['fund_purpose']) and isset($_POST['description']) and isset($_POST['amount']) and isset($_POST['paymethod']) and isset($_POST['payment_date']) and isset($_POST['created_by'])) {
    ...
    $phone = $_SESSION['phone_number_one'];
    $fund_purpose_to_add_offering_to_income = $_POST['fund_purpose_to_add_offering_to_income'];
    $pledge_category = 1;
    ...
    // $lecrosoft = "INSERT INTO `pledges_payment_histroy`(`campaign_id`, `member_id`, `description`, `amount`, `payment_method_id`, `payment_date`,`transaction_id`) VALUES ($fund_purpose,$pledger_name,'$description','$amount',$paymethod,'$payment_date','$transactionID')";
    ...
    $lecrosoft_add_to_income = "INSERT INTO `income_and_expense`(`income_and_expenses_category_id`, `note`, `transaction_date`, `payment_method_id`, `income`,`entered_by`) VALUES ($fund_purpose_to_add_offering_to_income,'$description','$payment_date',$paymethod,'$amount','$created_by')";
